    ...
    <>
      ...
      {/* <div className="p-6 bg-gray-50 min-h-screen">
        ...
        <div className="space-y-4">
         ...
         { order.payment.mode === "Prepaid"  ?    <div className="me-2 mt-1.5 inline-flex items-center rounded bg-green-100 px-2.5 py-0.5 text-xs font-medium text-green-800 dark:bg-green-900 dark:text-green-300">
...
{/* 
      ...
      <div className="mt-6 flow-root sm:mt-8 ">
        <div className="divide-y divide-gray-200 dark:divide-gray-700  flex flex-col-reverse">
         { orders.map((order, index) =><div key={index} className="flex flex-wrap items-center gap-y-4 py-6">
