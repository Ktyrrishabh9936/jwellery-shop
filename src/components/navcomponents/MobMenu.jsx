...
export default function MobMenu({ Menus }) {
  ...
  return (
    <div>
      <IconButton className="lg:hidden z-[100] relative bg-transparent text-pink-500 border-2 border-pink-300 " onClick={toggleDrawer}>
      ...
      { user ? <div class=" mx-auto my-10 bg-white rounded-lg shadow-md p-5">
    <Image height={600} width={600}  class="w-32 h-32 rounded-full mx-auto" src="/images/user.svg" alt="Profile picture"/>
    <h2 class="text-center text-2xl font-semibold mt-3 capitalize">{user?.name}</h2>
