...
const videoReels = [
  {
    ...
    videoUrl: "https://res.cloudinary.com/dk1thmps6/video/upload/products/videos/10414-bbe1f1a1-cc91-40af-aea1-61f1b0f532ac",
                ...
                <SwiperSlide key={reel.id} className="!w-[300px] md:!w-[400px]">
                  <div className="relative aspect-[9/16] rounded-3xl overflow-hidden shadow-2xl bg-black">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 text-white">
                      ...
                      <p className="text-sm opacity-90" style={{ fontFamily: "Glacial Indifference, sans-serif" }}>
                        {reel.description}
                      </p>
                    </div>
                  </div>
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  /> */}
                  <div>
                    <h4 className="font-semibold text-gray-900" style={{ fontFamily: "Cinzel, serif" }}>
                      {testimonial.name}
                    </h4>
                    <p className="text-sm text-gray-600" style={{ fontFamily: "Glacial Indifference, sans-serif" }}>
